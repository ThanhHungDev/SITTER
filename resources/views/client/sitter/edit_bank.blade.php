...
<div class="sitter-common">
    <div class="max-width-780 sitter-register">
        ...
        <form method="post" action="{{ route('SITTER_POST_EDIT_BANK') }}" id="bank-account-form">
            {{ csrf_field()}}
            <div class="div-title height-55 back-ground-green">
                <span class="fs-20 span-title">銀行口座を編集する</span>
            </div>
            ...
            <div class="text-center mt-50 mb-50 ml-1">
                <button type="submit" class="btn btn-default btn-sitter-register">更新</button>
            </div>
            <div class="outcome">
                <div class="error"></div>
            </div>

...
class VALIDATE_SITTER_REGISTER_PARENT extends FormRequest
{
    ...
    public function rules()
    {
        $validates = [
            ...
            'input_file_qualifi'    => 'required|mimes:jpg,jpeg,png,bmp|max:50000',
